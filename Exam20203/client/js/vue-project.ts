...
renderAsyncComponent('view-transaction', () => import('./components/ViewTransaction.vue'));
renderAsyncComponent('registration-user', () => import('./components/RegistrationUser.vue'));
